...
Class GIFEncoder {  
        ...
        * @param $GIF_src   静态gif文件路径数组

        * @param $GIF_dly   每个静态gif文件的显示时间数组，单位百分之一秒

        * @param $GIF_lop   循环次数，0表示无限循环
        ...
        * @param $GIF_red  指定静态gif文件上面的透明色，如不指定则，统一为-1

        * @param $GIF_mod  一般采用url，指$GIF_src指向了静态gif文件
